...
ShaderProgram2 *spLambert;
ShaderProgram2 *spConstant;

void initShaders(){
    spLambert=new ShaderProgram2("v_lambert.glsl",NULL,"f_lambert.glsl");
    spConstant=new ShaderProgram2("v_constant.glsl",NULL,"f_constant.glsl");
}
...
char* ShaderProgram2::readFile(const char* fileName) {
	int filesize;
	FILE *plik;
	char* result;
...
GLuint ShaderProgram2::loadShader(GLenum shaderType,const char* fileName) {
...
ShaderProgram2::ShaderProgram2(const char* vertexShaderFile,const char* geometryShaderFile,const char* fragmentShaderFile) {
...
GLuint ShaderProgram2::u(const char* variableName) {
...
GLuint ShaderProgram2::a(const char* variableName) {
